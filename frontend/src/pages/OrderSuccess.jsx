...
=========================================
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-12 min-h-screen">
      <div className="text-center space-y-4">
        <CheckCircle2 className="w-16 h-16 text-brand-500 fill-brand-500/10 mx-auto" />
        <h1 className="font-display font-black text-3xl sm:text-4xl text-apple-dark">Thank You for Your Order!</h1>
        <p className="text-xs sm:text-sm text-apple-dark/60">Order ref: #{order._id}</p>
      </div>
      <div className="p-8 rounded-3xl bg-white border border-black/5 shadow-sm space-y-8">
        <h3 className="font-display font-bold text-sm uppercase tracking-wider text-apple-dark">Delivery Tracking</h3>
            ...
            return (
              <div key={idx} className="flex md:flex-col items-center md:items-start gap-4 md:gap-3 text-left relative z-10">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-display font-bold text-xs border-2 ${
                  isCompleted 
                    ? 'bg-apple-dark border-apple-dark text-white' 
                    : 'bg-white border-black/10 text-apple-dark/40'
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        <div className="md:col-span-2 p-8 rounded-3xl bg-white border border-black/5 shadow-sm space-y-6">
          <h3 className="font-display font-bold text-sm uppercase tracking-wider text-apple-dark">Items Ordered</h3>
        ...
        <div className="p-8 rounded-3xl bg-white border border-black/5 shadow-sm space-y-6">
          <h3 className="font-display font-bold text-sm uppercase tracking-wider text-apple-dark">Summary</h3>
          ...
          <button 
            ...
            className="w-full py-2.5 rounded-full border border-black/10 hover:border-brand-500 hover:text-brand-500 text-apple-dark text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
          >
            Download Invoice
          </button>
        </div>
