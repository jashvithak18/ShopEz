      ...
      <AnimatePresence mode="wait">
        {booting ? (
          <motion.div
            ...
            initial={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-brand-50 z-[9999] flex flex-col items-center justify-center px-6 text-center space-y-8 overflow-hidden"
          >
            ...
            {/* Glowing Custom LogoMark in Center */}
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 16, ease: 'linear', repeat: Infinity }}
              className="relative z-10"
            >
              <LogoMark className="w-14 h-14 text-[#2563EB]" glow={true} />
            </motion.div>
            ...
            <div className="h-6 overflow-hidden relative w-80 z-10">
              <AnimatePresence mode="popLayout">
                <motion.p
                  ...
                  className="font-sans font-semibold text-xs tracking-wider text-[#111827] absolute left-0 right-0 uppercase"
                >
            ...
            <div className="w-48 h-[2px] bg-black/5 rounded-full overflow-hidden relative z-10 shadow-inner">
              <motion.div
                ...
                className="h-full bg-gradient-to-r from-[#3B82F6] to-[#1D4ED8] shadow-[0_0_8px_rgba(37,99,235,0.4)]"
              />
            </div>
          </motion.div>
        ) : (
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex flex-col min-h-screen bg-brand-50 selection:bg-brand-500 selection:text-white"
          >
            <Navbar />
