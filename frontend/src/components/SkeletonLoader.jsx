...
export function CatalogSkeleton() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {[...Array(8)].map((_, i) => (
        <div key={i} className="bg-white rounded-3xl p-6 border border-black/5 space-y-6 animate-pulse">
          <div className="aspect-video w-full rounded-2xl bg-black/5 flex items-center justify-center">
            <svg className="w-16 h-16 text-apple-dark/10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
          ...
          <div className="space-y-3">
            ...
            <div className="h-4.5 w-3/4 bg-black/5 rounded-full" />
            <div className="h-3.5 w-1/2 bg-black/5 rounded-full" />
          </div>
